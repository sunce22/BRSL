...
- [ ] **Автодетект героїв не працює** `🔒` — `hero_detector.py` не детектує в OBS. Аналіз нижче.
...
- [x] **Взаємодія з гайдами по героям** `🌐` — швидкий доступ під час стріму.

- [x] **Посилання на гайди з картки героя** `🌐` — кнопка на картці → hellhades/ayumilove.
